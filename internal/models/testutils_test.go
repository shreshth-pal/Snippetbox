...
script, err := os.ReadFile("D:/For the Love of Go (2023 edition)(1)/snippetbox/Snippetbox/internal/models/tesdata/setup.sql")
if err != nil {
t.Fatal(err)
}
...
t.Cleanup(func() {
script, err := os.ReadFile("D:/For the Love of Go (2023 edition)(1)/snippetbox/Snippetbox/internal/models/tesdata/teardown.sql")
if err != nil {
t.Fatal(err)
}
_, err = db.Exec(string(script))
